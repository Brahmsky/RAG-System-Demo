...
2. 查看控制台输出的详细错误信息
3. 确认文档格式和编码正确
4. 参考 `HANDOVER_DOCUMENT.md` 了解最新架构变更

---

## 📝 版本历史

### v2.0 (2025-10-11) - 架构重构与多模态准备 🏗️
- ✅ **模块化重构**: 代码按功能分层（core/text/graph/generation/utils）
- ✅ **图谱查询优化**: Cypher自动修复机制，提升成功率
- ✅ **数据库增强**: 新增状态可视化（get_stats, get_all_sources）
- ✅ **Bug修复**: 修复文本检索关键bug
- ✅ **日志优化**: 简化输出，保留核心信息
- 🎨 **多模态准备**: 创建测试语料和目录结构

### v1.0 (2024-10) - 双引擎RAG系统
- ✅ 完成文本检索 + 知识图谱双引擎架构
- ✅ 支持多种检索策略和结果优化
- ✅ 实现多格式文档和多语言处理
